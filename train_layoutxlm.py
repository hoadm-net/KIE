"""
Train LayoutXLM trên FUNSD dataset
"""
import torch
...
from transformers import (
    LayoutLMv2ForTokenClassification,  # LayoutXLM sử dụng LayoutLMv2 architecture
    LayoutXLMProcessor,
...
class LayoutXLMTrainer:
    ...
    def __init__(
        ...
        num_epochs: int = 10,
        output_dir: str = "outputs_layoutxlm",
    ...
    def train_epoch(self, epoch: int):
        ...
        for step, batch in enumerate(progress_bar):
            ...
            outputs = self.model(
                ...
                bbox=bbox,
                image=image,  # LayoutXLM uses 'image' parameter
                labels=labels
            )
    ...
    def train(self):
        """Main training loop"""
        print("\n" + "="*60)
        print("STARTING TRAINING - LayoutXLM")
        print("="*60 + "\n")
...
def main():
    parser = argparse.ArgumentParser(description="Train LayoutXLM on FUNSD")
    parser.add_argument(
        "--data_dir",
        type=str,
        default="data/FUNSD",
    ...
    # Initialize model
    # LayoutXLM uses LayoutLMv2 architecture
